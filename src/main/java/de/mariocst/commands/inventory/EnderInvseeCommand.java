...
public class EnderInvseeCommand implements CommandExecutor, TabCompleter {
    @Override
                    ...
                    try {
                        ...
                        if (t != null) {
                            if (t.getName().equals(player.getName())) {
                                sender.sendMessage(MarioMain.getPrefix() + "Du kannst doch wohl noch deine eigene EnderChest öffnen...");
