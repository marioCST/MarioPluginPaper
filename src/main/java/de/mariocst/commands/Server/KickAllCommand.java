            ...
            try {
                if (args.length == 0) {
                    ...
                    if (count == 0) {
                        ...
                        Bukkit.getConsoleSender().sendMessage(MarioMain.getPrefix() + "Alle Spieler gekickt!");
                    }
                }
                    ...
                    if (count == 0) {
                        ...
                        Bukkit.getConsoleSender().sendMessage(MarioMain.getPrefix() + "Alle Spieler mit dem Grund " + reason + " gekickt!");
                    }
                }
                else {
